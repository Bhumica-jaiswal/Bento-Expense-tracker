...
const faqs = [
  {
    question: "Is my financial data secure on Bento?",
    answer:
      "Yes. Bento uses advanced encryption (AES-256) and secure HTTPS connections to protect your data. All personal and financial details are encrypted both in transit and at rest. We never share or sell your data to anyone.",
  },
  {
    question: "Can I scan and upload receipts using Bento?",
    answer:
      "Absolutely! Bento integrates Google Gemini AI for OCR-based receipt scanning. Just upload a photo of your receipt, and the app automatically extracts merchant name, amount, and date, then categorizes it as a transaction.",
  },
  {
    question: "Do I need to pay to use Bento?",
    answer:
      "No. Bento is completely free to use for personal finance tracking. In future, we may introduce optional premium features like multi-account analytics or AI-based financial insights.",
  },
  {
    question: "Can I access my account from multiple devices?",
    answer:
      "Yes. Bento is a web-based app, so you can securely log in from any device—desktop, tablet, or mobile browser. Your data stays synced across all devices automatically.",
  },
  {
